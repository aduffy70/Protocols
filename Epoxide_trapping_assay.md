...
## Trapping Buffer (80mM Potassium Phosphate, 25mM KCl, 5mM MgCl<sub>2</sub>, 0.25mM sucrose, pH 7.6):
...
200x MgCl<sub>2</sub>-6H<sub>2</sub>O (1.23M):
  * 2.5g MgCl<sub>2</sub>-6H<sub>2</sub>O (203.31 mw)
  * water to 10mL
  * Make 1.1 and 0.6mL aliquots, store at -20.
...
10x K<sub>2</sub>HPO<sub>4</sub> (0.8M):
  * 7g K<sub>2</sub>HPO<sub>4</sub> dibasic (174.18 mw)
  * water to 50mL
  * Store in fridge

10x KH<sub>2</sub>PO<sub>4</sub> (0.8M):
  * 5.4g KH<sub>2</sub>PO<sub>4</sub> monobasic (136.09 mw)
  * water to 50mL
  * Store in fridge

Buffer 1 (80mM K<sub>2</sub>HPO<sub>4</sub> dibasic, pH~8.8):
  * 10mL 10X K<sub>2</sub>HPO<sub>4</sub>
  * 90mL water

Buffer 2 (80mM KH<sub>2</sub>PO<sub>4</sub> monobasic, “low” pH):
  * 10mL 10X KH<sub>2</sub>PO<sub>4</sub>
  * 0.5mL 200x sucrose
  * 0.5mL 200x MgCl
  * 1mL 100x KCl
  * water to 100mL
